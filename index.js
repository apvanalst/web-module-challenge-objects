...
console.log('-----Task 1-----');
const tea = createMenuItem('Green Tea', 3, 'Drinks');
console.log(tea);
const toast = createMenuItem('Rye Toast', 8, 'Breakfast');
console.log(toast);
const soup = createMenuItem('Tomato Soup', 2, 'Side');
console.log(soup);
...
reviews.push({ name: 'John', rating: 5, feedback: 'Great meal and fast service' });
console.log('-----Task 5-----');
console.log(reviews);
